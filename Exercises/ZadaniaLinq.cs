...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie04_PierwszyPrzedmiotAnalityczny()
    {
        ...
        return p is not null
            ? [$"{p.Nazwa} | start: {p.DataStartu:yyyy-MM-dd}"]
    ...
    public IEnumerable<string> Zadanie05_CzyIstniejeNieaktywneZapisanie()
    {
        ...
        return [$"Czy istnieje nieaktywny zapis: {(istnieje ? "Tak" : "Nie")}"];
    }
    ...
    {
        var wszyscy = DaneUczelni.Prowadzacy.All(p => !string.IsNullOrEmpty(p.Katedra));
        return [$"Czy wszyscy prowadzący mają katedrę: {(wszyscy ? "Tak" : "Nie")}"];
    }
    ...
    public IEnumerable<string> Zadanie12_ParyStudentPrzedmiot()
    {
        return DaneUczelni.Zapisy
            .SelectMany(z => DaneUczelni.Studenci.Where(s => s.Id == z.StudentId),
                (z, s) => new { z, s })
            .SelectMany(x => DaneUczelni.Przedmioty.Where(p => p.Id == x.z.PrzedmiotId),
    ...
    {
        return DaneUczelni.Zapisy
            .Join(DaneUczelni.Przedmioty, z => z.PrzedmiotId, p => p.Id, (z, p) => p)
            .GroupBy(p => p.Nazwa)
    ...
    public IEnumerable<string> Zadanie16_NajwyzszaOcenaKazdegoStudenta()
    {
        return DaneUczelni.Studenci
            ...
            .Select(g => $"{g.Key.Imie} {g.Key.Nazwisko} | {g.Max(x => x.OcenaKoncowa):F1}");
    }
    ...
    public IEnumerable<string> Wyzwanie03_ProwadzacyISredniaOcenNaIchPrzedmiotach()
    {
        return DaneUczelni.Prowadzacy
            .SelectMany(pr => DaneUczelni.Przedmioty.Where(p => p.ProwadzacyId == pr.Id)
                ...
                (pr, z) => new { pr.Imie, pr.Nazwisko, z.OcenaKoncowa })
            .GroupBy(x => new { x.Imie, x.Nazwisko })
